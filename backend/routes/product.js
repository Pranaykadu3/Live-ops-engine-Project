...
//TEST OF ROUTES
router.get("/pranay/signup", (req, res) => {
  res.send("signup Route working!!");
});

//NEW USER
router.post("/api/pranay/signup", userSignupValidation, async (req, res) => {
...
router.put("/api/pranay/user/:emailId", async (req, res) => {
...
router.get("/api/pranay/userlist", async (req, res) => {
  try {
...
//FIND ALL REGISTER USER
router.delete("/api/pranay/delete/:id", async (req, res) => {
  try {
